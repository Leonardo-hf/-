...
@Data
public class dm_v_tr_grwy_mx implements Insert {
	...
	public PreparedStatement stat(Connection con) {
		try {
			return con.prepareStatement("INSERT INTO dm.dm_v_tr_grwy_mx (tran_date, ebank_cust_no, tran_code, login_type, return_msg, tran_time, sys_type, payee_acct_no, payer_acct_no, uid, tran_sts, payee_acct_name, mch_channel, tran_amt, etl_dt, return_code, payer_acct_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
